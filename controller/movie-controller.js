...
router.post("/api/movies", async (req, res) => {
    try {
        ...
        console.log(`findmovietitle`, findMovieTitle)
        ...
        // const newMovieTitle = await db.movie.create(findMovieId.dataValues.title, req.body.genreId,)
        // console.log(`new movie =`, newMovieTitle)
